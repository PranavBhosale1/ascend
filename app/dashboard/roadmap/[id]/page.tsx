...
import { BookOpen, Video, ChevronDown, ChevronRight, ChevronLeft, Bookmark, FileText, ArrowLeft, CheckCircle, Check, Map } from 'lucide-react'
    ...
    try {
      ...
      if (!response.ok) {
        ...
        toast.error("Failed to load roadmap", {
          description: errorData.message || "There was an error loading the roadmap from MongoDB"
        });
        return;
      }
                ...
                <TabsContent value="notes">
                  <div className="py-4">
                    <div className="rounded-lg border p-4">
                      ...
                      <div className="mt-4">
                        <textarea 
                          className="w-full min-h-[200px] p-3 rounded-md border resize-y"
